...
namespace VBLua.Terminal
{
    ...
    {
        object? client = null;
            List<(string, object)> args = new() { ("method", "GET"), ("namespace", Environment), ("userCommand", "cmd"), ("commandStatement", StandartInput), ("client", client), ("this", this) };
            // ----------------------- Execution --------------------- Execution --------------------                              
            switch (Environment)
        {
    ...
    public void Writing(object sender, KeyPressEventArgs e)
    {
        if (e.KeyChar == (char)Keys.Delete || e.KeyChar == (char)Keys.Back)
        {
            ...
            if (e.KeyChar == (char)Keys.Back && commandLine.SelectionStart <= 3) { e.Handled = true; }
        }
    ...
    private void outputLine_TextChanged(object sender, EventArgs e)
    {
